...
export function FollowupFormModal({ isOpen, onClose }: FollowupFormModalProps) {
  ...
  const validate = () => {
    ...
    if (!validateRequired(formData.studentId)) newErrors.studentId = '请选择学员';
    ...
    <div className="modal-backdrop">
      <div className="modal">
        <div className="modal-header">
          <h2 className="text-lg font-semibold text-gray-800">新增回访</h2>
        ...
        <div className="modal-body space-y-4">
          <div className="form-group">
            <label className="form-label">选择学员 *</label>
            <select
              className={cn('select', errors.studentId && 'input-error')}
